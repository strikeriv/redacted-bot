...
import { CacheType, Client, Events, GatewayIntentBits, Interaction } from "discord.js";
...
async function init(): Promise<void> {
  ...
  client.on(Events.InteractionCreate, (interaction: Interaction<CacheType>) => create(interaction));
